...
namespace DAL_PolyCafe
{
    public class DBUTil
    {
        public static string connString = @"Data Source=DESKTOP-IM381TA\SQLEXPRESS01;Initial Catalog=PolyCafeK;Integrated Security=True;Trust Server Certificate=True";
